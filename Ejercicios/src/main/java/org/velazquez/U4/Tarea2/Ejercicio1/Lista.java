package org.velazquez.U4.Tarea2.Ejercicio1;
...
public class Lista {
    ...
    public void insertarNumeroInicio(int numero) {
    ...
    public void insertarNumeroPosicion(Integer posicion, Integer numero) {
