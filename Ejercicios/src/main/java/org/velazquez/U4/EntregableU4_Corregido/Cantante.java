...
public class Cantante {
    ...
    private int edad_cantante;
    private String ciudad_origen;
    private Cancion[] lista_canciones = new Cancion[0];
    private int indice = 0;

    public Cantante(String nombre_artistico, String nombre_real, int edad_cantante, String ciudad_origen) {
    ...
    public String toString() {
        return "Cantante{" +
                ...
                ", edad_cantante=" + edad_cantante +
                ", ciudad_origen='" + ciudad_origen + '\'' +
                ", cancion=" + Arrays.toString(lista_canciones) +
                '}';
    }
    ...
    public void eliminar_cancion(Cancion cancion_eliminada) {
        ...
        Cancion[] copia_cancion = Arrays.copyOfRange(lista_canciones, posicion+1, lista_canciones.length);
