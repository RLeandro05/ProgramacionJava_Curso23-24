package org.velazquez.U7.Tarea7.Ejercicio12;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Suponiendo que tablaDNIs es un Stream<Socio>
        Integer[] tablaFamiliares = tablaDNIs
                .map(Socio::getNumFamiliaresSocio)
                .toArray(Integer[]::new);


        for (Integer entero : tablaFamiliares) {
            System.out.println("Familiares: "+entero);
        }
    }
}
