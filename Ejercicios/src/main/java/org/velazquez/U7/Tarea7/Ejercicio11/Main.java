package org.velazquez.U7.Tarea7.Ejercicio11;
...
public class Main {
    public static void main(String[] args) {
        ...
        Collection<String> coleccionNombres = new ArrayList<>();

        for (Socio socio : tablaDNIsOrdenados) {
            coleccionNombres.add(socio.getNombreSocio());
        }

        Collection<String> coleccionNombresOrdenados = coleccionNombres.stream().sorted().collect(Collectors.toCollection(ArrayList::new));

        System.out.println("Colección de socios ordenados por nombre: ");

        System.out.println(coleccionNombresOrdenados);
    }
}
