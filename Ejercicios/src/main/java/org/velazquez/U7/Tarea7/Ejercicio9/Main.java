package org.velazquez.U7.Tarea7.Ejercicio9;
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] nuevaTablaDNIs = new String[tablaDNIsOrdenados.length];

        int contador = 0;
        for (Socio socio : tablaDNIsOrdenados) {
            nuevaTablaDNIs[contador] = socio.getDniSocio();
            contador++;
        }
